...
class MutationHandler {
	...
	_handleContainerChildrenMutations( mutations, viewSelection ) {
		...
		const modelFromDomChildren = modelFromCurrentDom ? Array.from( modelFromCurrentDom.getChildren() ) : [];
		const currentModelChildren = currentModel ? Array.from( currentModel.getChildren() ) : [];
